...
You have advantage on Dexterity ([Stealth](git/3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide.
...
While in sunlight, you have disadvantage on attack rolls, as well as on Wisdom ([Perception](git/3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight.
