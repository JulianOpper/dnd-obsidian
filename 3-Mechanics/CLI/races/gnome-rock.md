...
Whenever you make an Intelligence ([History](git/3-Mechanics/CLI/rules/skills.md#History)) check related to magic items, alchemical objects, or technological devices, you can add twice your proficiency bonus, instead of any proficiency bonus you normally apply.
