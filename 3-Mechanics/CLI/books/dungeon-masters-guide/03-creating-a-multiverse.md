...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting ethereal forms in its path and carrying the debris for leagues. Travelers with a passive Wisdom ([Perception](git/3-Mechanics/CLI/rules/skills.md#Perception)) score of 15 or more receive `1d4` rounds of warning: a deep hum in the ethereal matter.
...
Visitors to the Beastlands find their hunting and stalking capabilities improved, and characters have advantage on Wisdom ([Animal Handling](git/3-Mechanics/CLI/rules/skills.md#Animal%20Handling)), Wisdom ([Perception](git/3-Mechanics/CLI/rules/skills.md#Perception)), and Wisdom ([Survival](git/3-Mechanics/CLI/rules/skills.md#Survival)) checks while there.
