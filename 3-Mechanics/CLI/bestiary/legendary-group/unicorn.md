...
- Creatures native to the unicorn's domain have an easier time hiding; they have advantage on all Dexterity ([Stealth](git/3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide.  
