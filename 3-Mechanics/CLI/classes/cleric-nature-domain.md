...
At 1st level, you learn one druid cantrip of your choice. This cantrip doesn't count against the number of cleric cantrips you know. You also gain proficiency in one of the following skills of your choice: [Animal Handling](git/3-Mechanics/CLI/rules/skills.md#Animal%20Handling), [Nature](git/3-Mechanics/CLI/rules/skills.md#Nature), or [Survival](git/3-Mechanics/CLI/rules/skills.md#Survival).
