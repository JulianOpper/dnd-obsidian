...
At 1st level, you learn two languages of your choice. You also become proficient in your choice of two of the following skills: [Arcana](git/3-Mechanics/CLI/rules/skills.md#Arcana), [History](git/3-Mechanics/CLI/rules/skills.md#History), [Nature](git/3-Mechanics/CLI/rules/skills.md#Nature), or [Religion](git/3-Mechanics/CLI/rules/skills.md#Religion).
