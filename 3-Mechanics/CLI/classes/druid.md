...
- (a) a wooden [shield](git/3-Mechanics/CLI/items/shield.md) or (b) any simple weapon  
...
You know Druidic, the secret language of druids. You can speak the language and use it to leave hidden messages. You and others who know this language automatically spot such a message. Others spot the message's presence with a successful DC 15 Wisdom ([Perception](git/3-Mechanics/CLI/rules/skills.md#Perception)) check but can't decipher it without magic.
