...
Once a card is drawn, it fades from existence. Unless the card is the [Fool](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Fool) or the [Jester](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Jester), the card reappears in the deck, making it possible to draw the same card twice.

## A Question of Enmity

Two of the cards in a deck of many things can earn a character the enmity of another being. With the [Flames](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Flames) card, the enmity is overt. The character should experience the devil's malevolent efforts on multiple occasions. Seeking out the fiend shouldn't be a simple task, and the adventurer should clash with the devil's allies and followers a few times before being able to confront the devil itself.

In the case of the [Rogue](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Rogue) card, the enmity is secret and should come from someone thought to be a friend or an ally. As Dungeon Master, you should wait for a dramatically appropriate moment to reveal this enmity, leaving the adventurer guessing who is likely to become a betrayer.

`dice: [](deck-of-many-things.md#^1-playing-card-card)`

| dice: 1d22 | Playing Card | Card |
|------------|--------------|------|
| 1 | Ace of diamonds | [Vizier](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Vizier)* |
| 2 | King of diamonds | [Sun](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Sun) |
| 3 | Queen of diamonds | [Moon](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Moon) |
| 4 | Jack of diamonds | [Star](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Star) |
| 5 | Two of diamonds | [Comet](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Comet)* |
| 6 | Ace of hearts | [The Fates](git/3-Mechanics/CLI/decks/deck-of-many-things.md#The%20Fates)* |
| 7 | King of hearts | [Throne](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Throne) |
| 8 | Queen of hearts | [Key](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Key) |
| 9 | Jack of hearts | [Knight](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Knight) |
| 10 | Two of hearts | [Gem](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Gem)* |
| 11 | Ace of clubs | [Talons](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Talons)* |
| 12 | King of clubs | [The Void](git/3-Mechanics/CLI/decks/deck-of-many-things.md#The%20Void) |
| 13 | Queen of clubs | [Flames](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Flames) |
| 14 | Jack of clubs | [Skull](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Skull) |
| 15 | Two of clubs | [Idiot](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Idiot)* |
| 16 | Ace of spades | [Donjon](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Donjon)* |
| 17 | King of spades | [Ruin](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Ruin) |
| 18 | Queen of spades | [Euryale](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Euryale) |
| 19 | Jack of spades | [Rogue](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Rogue) |
| 20 | Two of spades | [Balance](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Balance)* |
| 21 | Joker (with TM) | [Fool](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Fool)* |
| 22 | Joker (without TM) | [Jester](git/3-Mechanics/CLI/decks/deck-of-many-things.md#Jester) |
^1-playing-card-card
...
The card's [medusa](medusa.md)-like visage curses you. You take a −2 penalty on saving throws while cursed in this way. Only a god or the magic of [The Fates](git/3-Mechanics/CLI/decks/deck-of-many-things.md#The%20Fates) card can end this curse.
