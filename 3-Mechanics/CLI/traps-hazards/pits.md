...
A successful DC 15 Wisdom ([Perception](git/3-Mechanics/CLI/rules/skills.md#Perception)) check discerns an absence of foot traffic over the section of floor that forms the pit's cover. A successful DC 15 Intelligence ([Investigation](git/3-Mechanics/CLI/rules/skills.md#Investigation)) check is necessary to confirm that the trapped section of floor is actually the cover of a pit.
